...
function AppFooter() {
    ...
    // Don't show footer on the homepage or share page
    if (pathname === '/' || pathname.startsWith('/share/')) {
        return null;
    }
    // The logic to hide on HTML view is handled in the view page itself.
...
_s(AppFooter, "xbyQPtUVMO7MNj7WjJlpdWqRcTo=", false, function() {
    return [
...
//# sourceMappingURL=src_components_7957b581._.js.map