...
"[project]/src/app/data:d2cd8e [app-client] (ecmascript) <text/javascript>": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$d2cd8e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/src/app/data:d2cd8e [app-client] (ecmascript) <text/javascript>");
...
function EditorView({ documentId, initialDocument }) {
    ...
    const handleSave = ()=>{
        startTransition(async ()=>{
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$data$3a$d2cd8e__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["saveDocument"])(currentId, content, docType);
            if (result.error) {
                toast({
                    title: 'Error',
...
//# sourceMappingURL=src_260d25d4._.js.map